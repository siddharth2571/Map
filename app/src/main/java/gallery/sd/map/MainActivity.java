...
import gallery.sd.map.route.AbstractRouting;
import gallery.sd.map.route.Route;
import gallery.sd.map.route.RouteException;
import gallery.sd.map.route.Routing;
import gallery.sd.map.route.RoutingListener;

/**
 * Created by shraddha on 8/5/2016.
 */
public class MainActivity extends AppCompatActivity implements RoutingListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    private static final int[] COLORS = new int[]{R.color.colorPrimary, R.color.accent, R.color.colorAccent, R.color.colorPrimaryDark, R.color.primary_dark_material_light};
